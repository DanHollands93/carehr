...
const DashboardHeader = ({
  ...
  return <header className="border-b bg-card py-4 px-6 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4">
        <div className="relative">
          ...
          {unseenCount > 0 && <Badge variant="destructive" className="absolute -top-2 -right-2 h-5 w-5 flex items-center justify-center p-0 text-xs bg-red-600 hover:bg-red-600">
